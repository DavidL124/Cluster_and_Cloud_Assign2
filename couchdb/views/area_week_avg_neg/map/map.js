function (doc) {
    if (doc.sentiments || (doc.geo && (doc.geo.suburb || (doc.geo.geo_location && doc.geo.geo_location.full_name))) || doc.location || (doc.user && doc.user.location) || doc.city_rule_key) {
